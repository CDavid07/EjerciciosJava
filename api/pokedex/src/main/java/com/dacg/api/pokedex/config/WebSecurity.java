...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers(HttpMethod.GET, "/buscar/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/buscar/pokemon/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/capturar/{id}").permitAll()
                .antMatchers(HttpMethod.DELETE, "/escapar/{id}").permitAll()
                .antMatchers(HttpMethod.GET, "/record/{id}").permitAll()
                .antMatchers(HttpMethod.GET, "/capturados/{id}").permitAll()
